...
const { createSubCategory, getSubCategories, getSpecificSubCategories, updateSpecificSubCategories, deleteSpecificSubCategories, setCategoryIdFromParams, SetCategoryIdFromParams } = require('../services/subCategoryServices');
...
router.route('/').get(SetCategoryIdFromParams, getSubCategories).post(setCategoryIdFromParams, createSubCategoryValidator, createSubCategory)
